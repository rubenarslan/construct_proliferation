---
title: "Construct proliferation across fields: last 7 years"
---
...
```{r layout='l-screen-inset',  out.width='100%',   out.height='800px'}
p <- treemap_graph(tests, colors = pal)

save_image(p, "figures/treemap_overall_last_7.png", width = 1400, height = 700, 
           scale = 5)
