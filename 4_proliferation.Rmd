...
library(groundhog)
groundhog.library(c("tidyverse", "entropy", "ggrepel", "cowplot", "RColorBrewer", "plotly", "gglorenz", "rio"), date = "2024-02-24")
theme_set(theme_bw())
...
count_plot
ggsave("figures/fig_counts.pdf", width = 8, height = 4)
ggsave("figures/fig_counts.png", width = 8, height = 4)
```
...
cumsum_plot
ggsave("figures/fig_cumsums.pdf", width = 8, height = 4)
...
ggsave("figures/fig_cumsums_subdiscipline.pdf", width = 15, height = 6)
ggsave("figures/fig_cumsums.png", width = 8, height = 4)
```
...
freq_plot <- ggplot(test_frequency, aes(n, count)) + 
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        legend.position = "none")
freq_plot
ggsave("figures/fig_frequency_across.pdf", width = 6, height = 4)
ggsave("figures/fig_frequency_across.png", width = 6, height = 4)
...
freq_plot <- ggplot(test_frequency, aes(n, count)) + 
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        legend.position = "none")
freq_plot
ggsave("figures/fig_frequency_across_no0.pdf", width = 6, height = 4)
```
...
freq_plot <- ggplot(test_frequency, aes(n, count)) + 
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        legend.position = "none")
freq_plot
ggsave("figures/fig_frequency.pdf", width = 6, height = 4)
ggsave("figures/fig_frequency.png", width = 6, height = 4)
...
freq_plot <- ggplot(test_frequency, aes(n, count)) + 
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        legend.position = "none")
freq_plot
ggsave("figures/fig_frequency_no0.pdf", width = 8.5, height = 4)
```
...
ggsave("figures/fig_entropy.png", width = 8, height = 4)
```
#### by classification
```{r}
...
entropy_by_year %>% 
  ...
  theme_minimal(base_size = 14) +
   theme(panel.grid.major.x = element_line(linetype = "dashed"),
        ...
        plot.title = element_text(face="bold"),
        legend.position = "none") +
  ggtitle("Entropy in measure use over time")
```
...
entropy_by_year %>% 
  ...
  theme_minimal(base_size = 14) +
   theme(panel.grid.major.x = element_line(linetype = "dashed"),
        ...
        legend.position = "none") +
  ggtitle("Entropy in measure use over time")
ggsave("figures/fig_entropy_subdiscipline.pdf", width = 8, height = 4)
```
