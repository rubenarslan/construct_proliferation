...
ggsave("figures/entropy_subdiscipline.pdf", width = 8, height = 4)
ggsave("figures/entropy_subdiscipline.png", width = 8, height = 4)
```
##### constructs
```{r}
entropy_by_year <- psyctests_info %>% 
