---
title: "Construct proliferation: Cognitive Psychology"
---
...
library(groundhog)
groundhog.library(c("tidyverse", "entropy", "ggrepel", "cowplot", "readr",
...
save_image(p, "figures/treemap_cognitive.png", width = 1400, height = 700, 
           scale = 5)
save_image(p, "figures/treemap_cognitive.pdf", width = 1400, height = 700, 
           scale = 5)
p
```
